...
activities = {
    "Basketball": {
        "description": "Team sport focusing on ball handling, shooting, and competitive play",
        ...
        "Drama Club": {
        "description": "Explore acting, stage production, and perform in theatrical shows",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["mia@mergington.edu"]
        },
        "Art Studio": {
        "description": "Create paintings, drawings, and sculptures with guidance from mentors",
